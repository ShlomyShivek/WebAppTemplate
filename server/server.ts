...
import ApplicationActivityService = require('./services/applicationActivityService');
...
db.once('open', function callback () {
    ...
    let activityService = new ApplicationActivityService.ActivityLogService();
    activityService.applicationStarted();
});
